        ...
        if host:
            ...
            for proto, services in new_scan[host]['protocols'].items():
                for service in services:
                    ...
                    print(f"Service: {service['service']} Version: {service['version']} CVEs: {service['cves']}")  
...
def analyze_password():
    def on_analyze():
        ...
        if password:
            ...
            print("Analyse terminée")  # Indique que l'analyse est terminée
